<template>
    <div>
        <beautiful-chat :participants="participants" :titleImageUrl="titleImageUrl" :onMessageWasSent="onMessageWasSent"
            ...
            :disableUserListToggle="false" :messageStyling="messageStyling" @onType="handleOnType"
            @edit="editMessage" />
    </div>
</template>
<script>
export default {
    ...
    data() {
        return {
            ...
            titleImageUrl: '',
            messageList: [
                { type: 'text', author: `user2`, data: { text: `Hi! Hope your doing good, how can i help you ?` } },
